...
import { fetchProfessional, updateProfessional } from '@/lib/professionals';
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([prof, unitList]) => {
        ...
        setUnits(unitList);
        setSelectedUnitIds(prof.units?.map((u) => u.unitId) ?? []);
      })
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await updateProfessional(id, {
        ...
        unitIds: selectedUnitIds.length > 0 ? selectedUnitIds : [],
      });
