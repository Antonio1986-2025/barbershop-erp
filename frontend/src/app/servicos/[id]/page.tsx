...
import { fetchService, updateService } from '@/lib/services';
...
export default function EditarServicoPage() {
    ...
    fetchService(id)
      .then((s) => {
        setForm({
          ...
          commissionValue: s.commissionValue != null ? String(s.commissionValue) : '',
        });
      })
  ...
  if (loading) {
    return <div className="mx-auto max-w-lg p-6"><p className="text-zinc-500">Carregando...</p></div>;
  }
